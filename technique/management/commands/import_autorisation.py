...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        csvfile = settings.BASE_DIR / 'data' / 'autorisation.csv' 
        ...
        with open(csvfile, 'r', encoding='utf-8') as file:
            ...
            for row in csv_reader:
                libelle = row[1]  # Assuming libelle is in the 2nd column
                type, created = Typautorisations.objects.get_or_create(libelle=libelle) 
